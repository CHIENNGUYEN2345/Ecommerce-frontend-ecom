    ...
    const MyView = NotificationList.map((NotificationList, i)=>{
        ...
        <Card onClick={this.handleShow} className="notification-card">
            <Card.Body>
                ...
                <Button data-title={NotificationList.title} data-date={NotificationList.date} data-message={NotificationList.message} className='btn btn-default'>Details</Button>
            </Card.Body>
        </Card>
        </Col>
    });
